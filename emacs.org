...
#+begin_src emacs-lisp
  ...
  (when (eq system-type 'darwin)
    ...
    (after 'evil (define-key evil-insert-state-map (kbd "s-v") 'yank))
    (bind-keys
...
#+begin_src emacs-lisp
  (use-package windmove
    :defer t
    :commands
    laat/hydra-move-splitter-left
    laat/hydra-move-splitter-right
    laat/hydra-move-splitter-up
    laat/hydra-move-splitter-right
    :config
