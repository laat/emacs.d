...
#+begin_src emacs-lisp
  ...
  (defun laat/protocol-magit (data)
    ...
    nil)
  ;; location.href = "org-protocol://magit?repo=" + encodeURIComponent("/path/to/git/repo")
#+end_src
...
#+begin_src shell :tangle no
  ...
  encoded="$(node -e "console.log(encodeURIComponent(require('path').resolve(process.argv[1])))" $arg1)"
