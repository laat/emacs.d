...
When 'C-c C-c' or 'C-c C-l' are pressed in the magit commit message buffer, delete the magit-diff window related to the current repo.

#+begin_src emacs-lisp
  (defun laat/magit-cleanup-buffer ()
  ...
  (add-hook 'git-commit-setup-hook
            (lambda ()
              (add-hook 'with-editor-post-finish-hook #'laat/magit-cleanup-buffer nil t)
              (add-hook 'with-editor-post-cancel-hook #'laat/magit-cleanup-buffer nil t)))
#+end_src
...
#+begin_src emacs-lisp
  (use-package svelte-mode
    ...
    :config
    (add-to-list 'eglot-server-programs
                 '(svelte-mode . ("xcrun" "sourcekit-lsp"))))
#+end_src
* Org
** Base Config
