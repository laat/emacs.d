...
#+begin_src emacs-lisp
  ...
  ;; (defun laat/kill-magit-diff-buffer-in-current-repo (&rest _)
  ...
  ;;           (lambda ()
  ;;             (add-hook 'with-editor-post-finish-hook #'laat/kill-magit-diff-buffer-in-current-repo
  ;;                       nil t)
  ;;             (add-hook 'with-editor-post-cancel-hook #'laat/kill-magit-diff-buffer-in-current-repo
  ;;                       nil t)))
